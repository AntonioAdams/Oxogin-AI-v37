-- Simplified Credit System Tables for Oxogin AI
-- This file sets up the credit management system in Supabase without reset_date

-- Create credit balances table (simplified)
